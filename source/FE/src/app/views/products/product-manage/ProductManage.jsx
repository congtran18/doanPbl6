...
const Invoice2 = () => {
    ...
    const deletProductById = async productId => {
        ...
        if (confirmBox === true) {
            ...
            setShowToast({ show: true, message : "Sản phẩm được đưa vào thùng rác!", type: success ? 'success' : 'danger' })
                ...
                <Grid item md={12} xs={12}>
                    ...
                    <Card className="p-0">
                        <div className="mb-1 flex justify-between items-center">
                            <h4 className="font-medium">Quản lý sản phẩm</h4>
                        </div>
                        ...
                        <div className="flex mb-5 justify-between items-center h-full">
                            <div className="flex">
                                ...
                                />
                                <Button variant='secondary' className="image8" to={'/products/restore'} as={Link}>
							        Khôi phục
						        </Button>
                            </div>
